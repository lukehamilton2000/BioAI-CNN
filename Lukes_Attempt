...
# Assign binary labels to the training data which represent with or without stitches
# 0 represents without stitches and 1 with, file is read through alphabetically so data was just manually assigned
train_data.class_indices = {'without_stitches': 0, 'with_stitches': 1}

# Modify the train_data generator to include the target labels
